...
If your Local is listed in the Locals directory and you are preparing for your next meetup, move ahead to [Resources](./resources.md).
:::

Launching a new GraphQL Local Gathering follows a predictable set of milestones. Use the checklist below to move from idea to your first public event.
...
- https://guild.host is a great free option and it runs on GraphQL! Many of our Local Gatherings use this platform, make sure to add your group to the [GraphQL Network](https://guild.host/graphql-foundation/network).
