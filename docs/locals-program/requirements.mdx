...
:::note Already approved? If you've already agreed to these requirements, have a
look at the [available resources](./resources.md).
...
- These **activities will be recorded**, or photographed if recording isn’t
  practical or appropriate, and made freely available online with or without
  editing.
  - Publishing to
    [@GraphQLFoundationTalks on YouTube](https://www.youtube.com/@GraphQLFoundationTalks)
    is possible - just ask!
    - In the case that events are in a language other than English, it may be
      possible to host videos on a language-specific GraphQL YouTube channel
...
gatherings. To start a new GraphQL Local, please contact us `local@graphql.org`
