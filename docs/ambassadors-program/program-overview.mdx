---
title: GraphQL Ambassador Program
sidebar_position: 2
sidebar: ambassadors
---
...
If you are coordinating the program rather than acting as an ambassador, jump to for partner alignment workflows.
:::
...
the [Standards Of Excellence](./standards.md).
...
A new wave of Ambassadors will be announced quarterly; the
first announcement was on stage at the GraphQL Conference in September 2025.

## Apply

Are you interested in becoming an official GraphQL Ambassador? Fill in the Application Form.

{

<LinkButton link="https://forms.gle/qXYEoG7iUatAb5bh6">
  Application Form
</LinkButton>
}
...
Have a question? Email `ambassadors@graphql.org`.
